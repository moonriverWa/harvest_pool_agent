...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    var findings, events, _i, events_1, ev;
    return __generator(this, function (_a) {
        findings = [];
        if (txEvent.to === consts_1.PANCAKESWAP_MAIN_STAKING.toLowerCase()) {
            console.log("HERE");
        }
        events = txEvent.filterLog(consts_1.EVENT, consts_1.PANCAKESWAP_MAIN_STAKING.toLowerCase());
